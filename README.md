...
## Course Description
Computational tools used in modern economics. Including application of data science in economics; visualization and manipulation of economic data; solving and simulating dynamic economic models. The course introduces computational methods for economic modeling with real datasets and numerical techniques. Key skills include data visualization, optimization, and translating economic problems into code.
...
## Topics
- Python: collections, control flow, functions
- NumPy, visualization, linear algebra, optimization
- Pandas data wrangling, time series
- Regression, random forests, NLP, reinforcement learning
